...
New [manuscript](https://arxiv.org/abs/2603.17495). TL;DR: we used Fitbod's data to find a better formula to estimate your one-rep-max (1RM) for a given exercise based on any arbitrary reps x weight combination.
